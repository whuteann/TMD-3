...
import { generateSparesPurchaseVoucherPDF } from '../../pdf/generateSparesPurchaseVoucherPDF';
...
const ViewTabSparesPV: React.FC<inputProps> = ({
  ...
  let route = "ViewSparesPurchaseVoucherSummary";
  ...
  return (
    <TouchableOpacity onPress={path} activeOpacity={0.80}>
...
export default ViewTabSparesPV;